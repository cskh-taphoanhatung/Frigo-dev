...
- **Next exact action:** commit the implementation and docs checkpoint, push/open the new Canary wiring PR, wait for exact-head CI SUCCESS and zero unresolved review threads, then stop with PR open for independent review. Do not merge or dispatch production.
