...
echo "D1 schema gate passed: required migrations (0001-0017 and 0019-0032), security/Week schema, recipe foundation, ranking persistence, generated plans, inventory truth, lot command/event/FEFO/adoption authority, observation/reconciliation persistence and guards, scan evidence retention/completeness, and foreign keys are valid."
