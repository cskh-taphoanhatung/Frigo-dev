...
const migration = readFileSync('migrations/0025_inventory_lot_commands.sql', 'utf8');
const eventAuthorityMigration = readFileSync('migrations/0026_inventory_event_authority.sql', 'utf8');
const eventPoststateMigration = readFileSync('migrations/0027_inventory_event_poststate.sql', 'utf8');
